...
This directory contains comprehensive tests generated by Claude AI for the drand-client project.
The tests are designed to provide good coverage and catch real bugs in your application.

## 🧪 Generated Test Files

- `defaults.test.ts` - Application tests
- `speedtest.test.ts` - Application tests
- `version.test.ts` - Application tests
- `client-integration.test.ts` - End-to-end tests
- `chain-verification.test.ts` - Application tests
- `speedtest-performance.test.ts` - Application tests
